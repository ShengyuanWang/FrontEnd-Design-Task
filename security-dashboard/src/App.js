  ...
  return (
    <Router>
      <Routes>
        <Route
          path="/login"
          element={auth ? <Navigate to="/" /> : <LoginPage setAuth={setAuth} />}
        />
        <Route path="/create-user" element={<CreateUserPage />} />
        <Route
          path="/upload"
          element={auth ? <UploadPage /> : <Navigate to="/login" />}
        />
        <Route
          path="/profile"
        ...
        <Route
          path="/processing"
          element={auth ? <ProcessingPage /> : <Navigate to="/login" />}
        />
        <Route
          path="/alert/:alertId"
          element={auth ? <AlertPage /> : <Navigate to="/login" />}
        />
        <Route
          path="/network/:alertId"
          element={auth ? <NetworkPage /> : <Navigate to="/login" />}
        />
        <Route
          path="/"
          element={
